...
<head>
    ...
    {{-- <title>{{ config('app.name', 'SchoolSavvy') }}</title> --}}
    <title>SchoolSavvy</title>
...
<body>
    <div id="app">
        <nav class="navbar sticky-top navbar-expand-md navbar-light bg-dark border-btm-e6" >
            <div class="container">
                <a class="navbar-brand text-white" href="{{ url('/') }}">
                    {{-- <i class="bi bi-house"></i> --}}
                    <img src="{{asset('/storage/photos/logo.png')}}" class="rounded"  height="30" width="30">
                    SchoolSavvy
                </a>
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            ...
                            @elseif(\App\Models\SchoolSession::latest()->count() > 0)
                                <a class="nav-link disabled text-white" href="#" tabindex="-1" aria-disabled="true">Current Academic Session {{$current_school_session_name}}</a>
                            @else
                                <a class="nav-link text-danger disabled text-white" href="#" tabindex="-1" aria-disabled="true"><i class="bi bi-exclamation-diamond-fill me-2"></i> Create an Academic Session.</a>
                            @endif
                        </li>
                    </ul>
                    @endauth
