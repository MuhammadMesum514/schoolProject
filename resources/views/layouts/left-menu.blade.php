<div class="col-xs-1 col-sm-1 col-md-1 col-lg-2 col-xl-2 col-xxl-2 border-rt-e6 px-0 bg-dark text-white">
    <div class="d-flex flex-column align-items-center align-items-sm-start min-vh-100">
                <ul class="nav flex-column pt-2 w-100 text-white" style="color:white !important;">
                    <li class="nav-item">
                    ...
                    <li class="nav-item border-bottom">
                        <a class="nav-link {{ request()->is('routine*')? 'active' : '' }}" href="{{route('section.routine.create')}}"><i class="bi bi-calendar4-range"></i> <span class="ms-1 d-inline d-sm-none d-md-none d-xl-inline">Schedule</span></a>
                    </li>
                    @endif
