                        ...
                        <form class="row g-3" action="{{route('school.student.create')}}" method="POST">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-2">
                                    ...
                                    <input type="text" class="form-control" id="inputCity" name="city" placeholder="Rawalpindi ..." required>
                                </div>
                                <div class="col-2">
                                ...
                                <div class="col-2">
                                    ...
                                    <input type="text" class="form-control" id="inputNationality" name="nationality" placeholder="e.g. Pakistan, UK, ..." required>
                                </div>
                                <div class="col-2">
                                ...
                                <div class="col-3">
                                    ...
                                    <input type="text" class="form-control" id="inputPhone" name="phone" placeholder="+92 3xx ......" required>
                                </div>
                                <div class="col-5">
                            ...
                            <div class="row mt-4 g-3">
                                ...
                                <div class="col-3">
                                    ...
                                    <input type="text" class="form-control" id="inputFatherPhone" name="father_phone" placeholder="+92 3xx ......" required>
                                </div>
                                <div class="col-3">
                                ...
                                <div class="col-3">
                                    ...
                                    <input type="text" class="form-control" id="inputMotherPhone" name="mother_phone" placeholder="+92 3xx ......" required>
                                </div>
                                <div class="col-4">
