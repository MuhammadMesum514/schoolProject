                        ...
                        <form class="row g-3" action="{{route('school.student.update')}}" method="POST">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-2">
                                    ...
                                    <input type="text" class="form-control" id="inputCity" name="city" placeholder="Rawalpindi ..." required value="{{$student->city}}">
                                </div>
                                <div class="col-2">
                                ...
                                <div class="col-3">
                                    ...
                                    <input type="text" class="form-control" id="inputPhone" name="phone" placeholder="+92 3xx ......" required value="{{$student->phone}}">
                                </div>
                                <div class="col-3">
                            ...
                            <div class="row mt-4 g-3">
                                ...
                                <div class="col-3">
                                    ...
                                    <input type="text" class="form-control" id="inputFatherPhone" name="father_phone" placeholder="+92 3xx ......" required value="{{$parent_info->father_phone}}">
                                </div>
                                <div class="col-3">
                                ...
                                <div class="col-3">
                                    ...
                                    <input type="text" class="form-control" id="inputMotherPhone" name="mother_phone" placeholder="+92 3xx ......" required value="{{$parent_info->mother_phone}}">
                                </div>
                                <div class="col-4">
