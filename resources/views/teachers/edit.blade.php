                    ...
                    <div class="mb-4">
                        <form class="row g-3" action="{{route('school.teacher.update')}}" method="POST">
                            ...
                            <div class="col-2">
                                ...
                                <input type="text" class="form-control" id="inputCity" name="city" placeholder="Rawalpindi ..." required value="{{$teacher->city}}">
                            </div>
                            <div class="col-2">
                            ...
                            <div class="col-3">
                                ...
                                <input type="text" class="form-control" id="inputPhone" name="phone" placeholder="+92 3xx ......" required value="{{$teacher->phone}}">
                            </div>
                            <div class="col-2">
